...
dirpath = './dataset-input-pipit/Train'
# Open pt file
...
dirpath = './dataset-input-pipit/Test'
# Open pt file
...
names = ['F72726', 'F91903', 'F91907', 'F91913', 'F91915', 'F91916', 'F91954',
       'F91959', 'F91969', 'F91973']
...
config.num_labels = 10 # SMOOTH OUT
...
#    print(all(not paream.requires_grad for param in layer.output.parameters()))
...
metric_1 = MulticlassAUROC(num_classes=10)
metric_2 = MulticlassAccuracy(average = 'none', num_classes = 10)
